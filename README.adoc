...
Gabriel Rodrigues is a Ph.D. candidate at the University of Brasília, under supervision of link:Prof. Genaína Rodrigues[https://genaina.github.io/], and co-supervision of link: []
...
- An Architecture for Mission Coordination of Heterogeneous Robots icon:file-pdf-solid[link="/preprint/rodrigues_architecture_2022.pdf", window="_blank"]
