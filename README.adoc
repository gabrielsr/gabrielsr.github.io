...
[[top]]
include::header.adoc[]
image::images/profile_small.jpg[role=left]

Short Bio:: Gabriel Rodrigues is a Ph.D. candidate at the University of Brasília, under the supervision of Prof. https://genaina.github.io/[Genaína Rodrigues], and are co-advised by Prof. http://www.patriziopelliccione.com/[Patrizio Pelliccione]. He also spent part of his Ph.D. candidature at the Chalmers University - Gothenburg, Sweden.

His research interest is in Software Engineering, Software Architecture, Self-Adaptive Systems, and Software Engineering for Robotics. Before the Ph.D., Gabriel worked for 10 years in the software industry. He received his master’s degree in Computer Science from the University of Brasilia in Brazil in 2015, and an MBA in Project Management from Getulio Vargas Foundation (FGV) in 2016.
...
icon:researchgate_ico[link="https://www.researchgate.net/profile/Gabriel-Rodrigues-16", window="_blank"]
